...
describe('AuthService', () => {
  ...
  describe('create', () => {
    ...
    it('should throw BadRequestException for invalid role', async () => {
      ...
      await expect(service.create(invalidRoleDto, 'admin123')).rejects.toThrow(
        BadRequestException,
      );
    });
  });
  ...
  describe('update', () => {
    ...
    it('should throw NotFoundException for non-existent user', async () => {
      ...
      await expect(
        service.update('nonexistent', updateUserDto, 'admin123'),
    ...
    it('should check for username conflicts', async () => {
      ...
      await expect(
        service.update('user123', conflictDto, 'admin123'),
  ...
  describe('changePassword', () => {
    ...
    it('should throw BadRequestException for password mismatch', async () => {
      ...
      await expect(
        service.changePassword('user123', mismatchDto),
      ).rejects.toThrow(
  ...
  describe('permission checking', () => {
    ...
    it('should check single permission correctly', () => {
      ...
      const noPermission = service.hasPermission(
        userWithPermissions,
        'users',
        'delete',
      );
    ...
    it('should check all permissions correctly', () => {
      ...
      const notHasAll = service.hasAllPermissions(
        userWithPermissions,
        missingPermission,
      );
  ...
  describe('role management', () => {
    ...
    it('should throw NotFoundException for invalid role', async () => {
      await expect(service.getRole('invalid_role')).rejects.toThrow(
        NotFoundException,
      );
    });
